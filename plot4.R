...
par(mfrow=c(2,2))
plot(real.data$DateTime, real.data$Global_active_power, type="l",xlab="",
     ylab="Global Active Power")
plot(real.data$DateTime, real.data$Voltage, type="l",xlab="datetime",
     ylab="Voltage")
...
plot(real.data$DateTime, real.data$Global_reactive_power, type="l",xlab="datetime",
